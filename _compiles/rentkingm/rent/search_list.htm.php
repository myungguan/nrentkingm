<?php /* Template_ 2.2.8 2017/12/28 16:47:16 /home/rentking/dev/rentking/old/sites/tpls/rentkingm/rent/search_list.htm 000007926 */ ?>
<div class="page">
	<ul>
...
<?php if($TPL_VAR["data"]["retype"]=='2'){?><div class="deposit">보증금: <span ><?php echo number_format($TPL_V1["precharge"])?></span>원</div><?php }?>
					<div class="price"><?php if($TPL_VAR["data"]["retype"]=='1'){?><span><?php echo number_format($TPL_V1["total_charge"])?></span>원<?php }else{?><span><?php echo number_format($TPL_V1["moncharge"])?></span>원<span class="month">/월</span><?php }?></div>
				</div>
				<div class="detail">
					<div class="insurance">
			...
			<button class="show-location"><?php echo $TPL_V1["affiliate"]?> (<?php echo number_format($TPL_V1["distance"]/ 1000, 1)?>&#13214;)</button>
						...
						<li>
							<a href="#<?php echo $TPL_V1["idx"]?>" class="reservation">
								...
								<div class="description">
									...
									<span class="price"><span><?php echo number_format($TPL_V1["charge"])?></span>원</span>
								</div>
							</a>
						</li>
<?php }?>
						...
						<li>
							<a href="#<?php echo $TPL_V1["idx"]?>" class="reservation" data-insu="1">
								...
								<div class="description">
									...
									<span class="price"><span><?php echo number_format($TPL_V1["charge"]+$TPL_V1["price_insu1"])?></span>원</span>
								</div>
							</a>
						</li>
<?php }?>
						...
						<li>
							<a href="#<?php echo $TPL_V1["idx"]?>" class="reservation" data-insu="2">
								...
								<div class="description">
									...
									<span class="price"><span><?php echo number_format($TPL_V1["charge"]+$TPL_V1["price_insu2"])?></span>원</span>
								</div>
							</a>
						</li>
<?php }?>
						...
						<li>
							<a href="#<?php echo $TPL_V1["idx"]?>" class="reservation" data-insu="3">
								...
								<div class="description">
									...
									<span class="price"><span><?php echo number_format($TPL_V1["charge"]+$TPL_V1["price_insu3"])?></span>원</span>
								</div>
							</a>
						</li>
<?php }?>
					...
					<li>
						<a href="#<?php echo $TPL_V1["idx"]?>" class="reservation">
							...
							<div class="description">
								...
								<span class="price"><span><?php echo number_format($TPL_V1["moncharge"])?></span>원 X <?php echo $TPL_VAR["data"]["months"]?>회</span>
							</div>
							<div class="description">
								<span class="con">마지막 월 대여료</span>
								<span class="price"><span><?php echo number_format($TPL_V1["leftcharge"])?></span>원</span>
							</div>
							<div class="description">
								<span class="con">전체 대여료</span>
								<span class="price"><span><?php echo number_format($TPL_V1["total_charge"])?></span>원</span>
							</div>
						</a>
					</li>
<?php }?>
