<?php /* Template_ 2.2.8 2017/12/28 16:47:16 /home/rentking/dev/rentking/old/sites/tpls/rentkingm/member/mypage.htm 000005498 */ ?>
<!DOCTYPE html>
<html lang="ko">
<head>
	...
	<div id="contentWrap">
		...
		<div class="form-box">
			...
			<div class="form-field row-100-a only-text">
				...
				<div class="col text-right"><?php echo $TPL_VAR["member"]["id"]?></div>
			</div>
			...
			<div class="form-field row-100-a">
				...
				<div class="col text-right"><?php echo phone_number_format($TPL_VAR["member"]["cp"])?>
