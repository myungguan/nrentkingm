<?php /* Template_ 2.2.8 2017/12/28 16:47:16 /home/rentking/dev/rentking/old/sites/tpls/rentkingw/rent/search.htm 000011735 */ ?>
<!DOCTYPE html>
<html lang="ko">
<head>
...
<?php $this->print_("header",$TPL_SCP,1);?>
	...
	<div id="searchWrap">
		<form action="/rent/search_list.php" id="searchForm">
			...
			<input type="hidden" name="grade_idx" value="<?php echo $TPL_VAR["data"]["grade"]?>" />
...
<?php }}?>
	...
	<script type="text/javascript" src="/js/rentking.w.search.min.js?20171127062239<?php if(!$TPL_VAR["global"]["production"]){?>_<?php echo time()?><?php }?>"></script>
