<?
/**
 * 어드민 > 차량관리 > 차량속성관리 > 등급관리
 * admin.rentking.co.kr/car.php?code=carcon2
 * 차량 속성관리_등급관리 페이지
 */
$mode = $_REQUEST['mode'];
if ($mode == 'w') {
...
<div class="row-fluid">
	<div class="span6">
		<span class="subTitle">등록된등급</span>
		...
		?>
		<tr>
			<td><?=$ar_ttype2_idx[$i];?></td>
			<td style='text-align:left;padding-left:5px;'><?=$ar_ttype2_sname[$ar_ttype2_idx[$i]];?></td>
		</tr>
		<?
		}
		?>
	...
	<div class="span6">	
		...
		<span class="subTitle">등급등록</span>
		<table class="detailTable2">
		<tbody>
		<tr>
			<th>등급명</th>
			<td><input type='text' maxlength="50" name='sname' valch="yes" msg="등급명"></td>
		</tr>
		</tbody>
		</table>
