<?
/**
 * 어드민 > 차량관리 > 차량속성관리 > 제조사관리
 * admin.rentking.co.kr/car.php?code=carcon1
 * 차량 속성관리_제조사관리 페이지
 */
$mode = $_REQUEST['mode'];
if ($mode == 'w') {
...
<div class="row-fluid">
	<div class="span6">
		<span class="subTitle">등록된제조사</span>
		...
		?>
		<tr>
			<td><?=$ar_ttype1_idx[$i];?></td>
			<td style='text-align:left;padding-left:5px;'><?=$ar_ttype1_sname[$ar_ttype1_idx[$i]];?></td>
		</tr>
		<?
		}
		?>
	...
	<div class="span6">	
		...
		<span class="subTitle">제조사등록</span>
		<table class="detailTable2">
		<tbody>
		<tr>
			<th>제조사명</th>
			<td><input type='text' maxlength="50" name='sname' valch="yes" msg="제조사명"></td>
		</tr>
		</tbody>
		</table>
