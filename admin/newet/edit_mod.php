...
/**
 * 어드민 > 사이트관리 > 게시물관리
 * admin.rentking.co.kr/admin/sho.php?code=bbs&boardid=notice
 * 게시물 관리 내 다음 에디터 사용 부분
 */
?>
<link rel="stylesheet" href="/newet/css/editor.css" type="text/css" charset="utf-8"/>
<script src="/newet/js/editor_loader.js" type="text/javascript" charset="utf-8"></script>
<div class="body_ed">
	<!-- 에디터 시작 -->
	<!--
		@decsription
	...
	<div id="tx_trex_container" class="tx-editor-container">
						...
						<div id="tx_richtextbox_menu" class="tx-richtextbox-menu tx-menu">
							...
							<div class="tx-menu-footer">
								<img class="tx-menu-confirm"
									 src="/newet/images/icon/editor/btn_confirm.gif?rv=1.0.1" alt=""/>
								<img class="tx-menu-cancel" hspace="3"
									 src="/newet/images/icon/editor/btn_cancel.gif?rv=1.0.1" alt=""/>
							</div>
						</div>
					</li>
					<li class="tx-list">
		...
		<div id="tx_canvas" class="tx-canvas">
			<div id="tx_loading" class="tx-loading">
				<div><img src="/newet/images/icon/editor/loading2.png" width="113" height="21" align="absmiddle"/></div>
			</div>
		...
		<div id="tx_resizer" class="tx-resize-bar">
			...
			<img id="tx_resize_holder" src="/newet/images/icon/editor/skin/01/btn_drag01.gif" width="58" height="12"
				 unselectable="on" alt=""/>
		</div>
		<div class="tx-side-bi" id="tx_side_bi">
			<div style="text-align: right;">
				<img hspace="4" height="14" width="78" align="absmiddle" src="/newet/images/icon/editor/editor_bi.png"/>
			</div>
		</div>
		<!-- 편집영역 끝 -->
		<!-- 첨부박스 시작 -->
			...
			<div id="tx_attach_box" class="tx-attach-box">
				<div class="tx-attach-box-inner">
					<div id="tx_attach_preview" class="tx-attach-preview"><p></p><img
								src="/newet/images/icon/editor/pn_preview.gif" width="147" height="108"
								unselectable="on"/></div>
...
<!-- 에디터 끝 -->
<textarea id="sample_contents_source" style="display:none;"><?= $memo; ?></textarea>
<script type="text/javascript">
	var config = {
		txHost: '', /* 런타임 시 리소스들을 로딩할 때 필요한 부분으로, 경로가 변경되면 이 부분 수정이 필요. ex) http://xxx.xxx.com */
		txPath: '/newet/', /* 런타임 시 리소스들을 로딩할 때 필요한 부분으로, 경로가 변경되면 이 부분 수정이 필요. ex) /xxx/xxx/ */
		txService: 'sample', /* 수정필요없음. */
		txProject: 'sample', /* 수정필요없음. 프로젝트가 여러개일 경우만 수정한다. */
		initializedId: "", /* 대부분의 경우에 빈문자열 */
		wrapper: "tx_trex_container", /* 에디터를 둘러싸고 있는 레이어 이름(에디터 컨테이너) */
		form: 'writeform' + "", /* 등록하기 위한 Form 이름 */
		txIconPath: "/newet/images/icon/editor/", /*에디터에 사용되는 이미지 디렉터리, 필요에 따라 수정한다. */
		txDecoPath: "/newet/images/deco/contents/", /*본문에 사용되는 이미지 디렉터리, 서비스에서 사용할 때는 완성된 컨텐츠로 배포되기 위해 절대경로로 수정한다. */
		canvas: {
			styles: {
				color: "#123456", /* 기본 글자색 */
