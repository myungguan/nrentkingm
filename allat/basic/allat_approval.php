<?php
  ...
  //----------------------
  $at_cross_key = "e4725bb6a7d25d7bef1eb6636bfce862";	//설정필요 [사이트 참조 - http://www.allatpay.com/servlet/AllatBiz/support/sp_install_guide_scriptapi.jsp#shop]
  $at_shop_id   = "rentking";		//설정필요
  $at_amt=500000;						//결제 금액을 다시 계산해서 만들어야 함(해킹방지), ( session, DB 사용 )
